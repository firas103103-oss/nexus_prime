...
const resources = {
  en: {
    translation: {
      ...
      boardroom: {
        badge: "COGNITIVE BOARDROOM",
        title: "THE BOARDROOM",
        subtitle: "Multi-agent AI meeting simulation where Mr. Firas (The Architect) conducts interactive sessions with 18 autonomous AI agents across 5 divisions.",
        agentsTitle: "X-BIO AGENTS (18 AI Entities)",
        featuresTitle: "Boardroom Features",
        feature1Title: "Intent Routing",
        feature1Desc: "AI automatically selects the most relevant agents based on your query.",
        feature2Title: "Turn-Taking Protocol",
        feature2Desc: "Agents respond sequentially without interruption for coherent meetings.",
        feature3Title: "Traffic Control",
        feature3Desc: "Daily message limits: Heads (20 msgs/day), Officers (10 msgs/day).",
        feature4Title: "Manual Override",
        feature4Desc: "Required for offensive actions like Kinetic Silo or Silent Wave activation.",
        accessTitle: "Access the Boardroom",
        accessDesc: "The Cognitive Boardroom runs as a separate Streamlit application.",
        agents: {
          sentinelPrime: "VP & The Engine",
          drJoe: "Lab Manager & Bio-Safety",
          engVector: "Hardware Lead & Kinetic Silo",
          drQuant: "Data Scientist & Algorithms",
          drSigma: "QA Architect & Testing",
          cmdrSwift: "Fleet Commander & Drones",
          officerHertz: "E-Warfare & Jamming",
          chiefForge: "Manufacturing & Assembly",
          theWarden: "Internal Security & SEI",
          counselorLogic: "Legal Advisor & Patents",
          wardenPrime: "Cybersecurity & Network",
          mrLedger: "CFO & Budget",
          chiefSource: "Procurement & Rare Chips",
          counselorPact: "Contracts & NDAs",
          ambassadorNexus: "External Relations",
          ambassadorNova: "CMO & Marketing",
          adminOracle: "Executive Assistant",
          xbioCore: "The System Mind"
        }
      }
    }
  },
  ar: {
    translation: {
      ...
      boardroom: {
        badge: "غرفة الاجتماعات الإدراكية",
        title: "غرفة الاجتماعات",
        subtitle: "محاكاة اجتماعات ذكاء اصطناعي متعددة الوكلاء حيث يعقد السيد فراس (المعماري) جلسات تفاعلية مع 18 وكيل ذكاء اصطناعي عبر 5 أقسام.",
        agentsTitle: "وكلاء X-BIO (18 كياناً)",
        featuresTitle: "ميزات غرفة الاجتماعات",
        feature1Title: "توجيه النية",
        feature1Desc: "الذكاء الاصطناعي يختار تلقائياً الوكلاء الأكثر صلة بناءً على استفسارك.",
        feature2Title: "بروتوكول تبادل الأدوار",
        feature2Desc: "الوكلاء يستجيبون بالتتابع دون انقطاع لاجتماعات متماسكة.",
        feature3Title: "التحكم في حركة المرور",
        feature3Desc: "حدود الرسائل اليومية: الرؤساء (20 رسالة/يوم)، الضباط (10 رسائل/يوم).",
        feature4Title: "التجاوز اليدوي",
        feature4Desc: "مطلوب للإجراءات الهجومية مثل تفعيل Kinetic Silo أو Silent Wave.",
        accessTitle: "الوصول إلى غرفة الاجتماعات",
        accessDesc: "غرفة الاجتماعات الإدراكية تعمل كتطبيق Streamlit منفصل.",
        agents: {
          sentinelPrime: "نائب الرئيس والمحرك",
          drJoe: "مدير المختبر والسلامة الحيوية",
          engVector: "قائد الأجهزة والصومعة الحركية",
          drQuant: "عالم البيانات والخوارزميات",
          drSigma: "معماري ضمان الجودة",
          cmdrSwift: "قائد الأسطول والطائرات المسيرة",
          officerHertz: "الحرب الإلكترونية والتشويش",
          chiefForge: "التصنيع والتجميع",
          theWarden: "الأمن الداخلي وبروتوكول SEI",
          counselorLogic: "المستشار القانوني وبراءات الاختراع",
          wardenPrime: "الأمن السيبراني والشبكات",
          mrLedger: "المدير المالي والميزانية",
          chiefSource: "المشتريات والرقائق النادرة",
          counselorPact: "العقود واتفاقيات السرية",
          ambassadorNexus: "العلاقات الخارجية",
          ambassadorNova: "مدير التسويق والتسويق",
          adminOracle: "المساعد التنفيذي",
          xbioCore: "عقل النظام"
        }
      }
    }
